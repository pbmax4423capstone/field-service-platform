...
export default async function DispatchPage() {
  ...
  const [{ data: technicians }, { data: todaysJobs }, { data: unschedJobs }] = await Promise.all([
    admin
      .from('users')
  ...
  const scheduledJobs: Job[] = (todaysJobs ?? []) as unknown as Job[]
  const unscheduledJobs: Job[] = (unschedJobs ?? []) as unknown as Job[]
