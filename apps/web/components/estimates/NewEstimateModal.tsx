...
export function NewEstimateModal({ customers }: Props) {
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-5 space-y-5">
              {/* Customer */}
              <div>
                <label className={LABEL_CLS} htmlFor="est-customer">
                  Customer
                </label>
                <select
                  id="est-customer"
              ...
              {/* Title */}
              <div>
                <label className={LABEL_CLS} htmlFor="est-title">
              ...
              {/* Valid Until */}
              <div>
                <label className={LABEL_CLS} htmlFor="est-valid-until">
                  Valid Until
                </label>
                <input
                  id="est-valid-until"
              ...
              {/* Notes */}
              <div>
                <label className={LABEL_CLS} htmlFor="est-notes">
                  Notes
                </label>
                <textarea
                  id="est-notes"
